    ...
    return (
        <div className="space-y-8 relative">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <MotionCard delay={0.1} className="p-6 flex flex-col min-h-0">
                    <motion.div 
                    ...
                    <div className="space-y-4 overflow-y-auto flex-1 h-full pr-2 min-h-0 max-h-[55vh]">
                ...
                {/* My Applications */}
                <MotionCard delay={0.2} className="p-6 flex flex-col min-h-0">
                    <motion.h2 
